...
<x-guest-layout>
    ...
    <div style="margin-bottom: 2rem;">
        <p class="verify-subheading">TUKANG VERIFICATION</p>
        <h1 class="verify-heading">CHECK YOUR MAIL</h1>
    </div>
    ...
    <div class="verify-text">
        {{ __('Welcome to the Come & Fix team! Before we can show your profile to customers, please verify your email address by clicking on the link we just sent. Didn\'t get it? No worries, we can send it again.') }}
    </div>

    <div class="action-container">
        <form method="POST" action="{{ route('tukang.verification.send') }}">
            @csrf
